...
class MyGeotabMenuItem(Gtk.MenuItem):
    ...
    def build_submenu(self, app):
        ...
        start_item.connect('activate', lambda _: geo.run_in_terminal('myg start', title='MyGeotab [ geo-cli ]'))
        ...
        restart_item.connect('activate', lambda _: geo.run_in_terminal('myg restart', title='MyGeotab [ geo-cli ]'))
